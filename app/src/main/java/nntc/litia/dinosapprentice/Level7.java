...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Активити 7-го уровня создано");
        ...
        /* Вызов диалогового окна 7-го уровня (Начало) */
        ...
        /* Установка фона в 7 уровень - начало */
        ImageView background = (ImageView)  findViewById(R.id.background);
        background.setImageResource(R.drawable.wscde);
        /* Установка фона в 7 уровень - конец */
        ...
        /* Вызов диалогового окна 7-го уровня (Конец) */
        ...
        btndialogcontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    Intent intent = new Intent(Level7.this, Level8plot1.class);
                    startActivity(intent);
                    finish();
                }
                catch (Exception e){
        ...
        /* Подготовка работы 7-го уровня, левой стороны (Начало) */
        ...
        /* Подготовка работы 7-го уровня, левой стороны (Конец) */

        /* Подготовка работы 7-го уровня, правой стороны (Начало) */
        // Генерация случайного числа
        ...
        /* Подготовка работы 7-го уровня, правой стороны (Конец) */
    ...
    protected void onStart() {
        super.onStart();
        Log.d(TAG, "Активити 7-го уровня становится видимым");
    }

    @Override
    protected void onResume(){
        super.onResume();
        Log.d(TAG, "Активити 7-го уровня получает фокус и переходит в состояние onResume");
    }

    @Override
    protected void onPause(){
        super.onPause();
        Log.d(TAG, "Активити 7-го уровня приостановленно и находится в состоянии onPause");
        if (sound_lvl != null) {
            sound_lvl.pause();
        }
    ...
    protected void onStop(){
        super.onStop();
        Log.d(TAG, "Активити 7-го уровня остановленно и находится в состоянии onStop");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
    ...
    protected void onDestroy(){
        super.onDestroy();
        Log.d(TAG, "Активити 7-го уровня уничтожено и находится в состоянии onDestroy");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
