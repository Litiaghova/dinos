...
public class Level2plot1 extends AppCompatActivity {
    static int j = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound_plot_2 = MediaPlayer.create(this, R.raw.history_sound_2_lvl);
        sound_plot_2.start();
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Начало конструкции
                try {
                    Intent intent = new Intent(Level2plot1.this, Level_Menu.class);
        ...
        button_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Начало конструкции
                try {
                    Intent intent = new Intent(Level2plot1.this, Level2.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                }
