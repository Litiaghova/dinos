...
public class Level4plot1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound_plot_2 = MediaPlayer.create(this, R.raw.history_sound_4_lvl);
        sound_plot_2.start();
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Начало конструкции
                try {
                    Intent intent = new Intent(Level4plot1.this, Level_Menu.class);
        ...
        button_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Начало конструкции
                try {
                    Intent intent = new Intent(Level4plot1.this, Level4.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                }
