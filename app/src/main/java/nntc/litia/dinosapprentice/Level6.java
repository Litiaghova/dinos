...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Активити 6-го уровня создано");
        ...
        /* Вызов диалогового окна 6-го уровня (Начало) */
        ...
        /* Вызов диалогового окна 6-го уровня (Конец) */
        ...
        /* Подготовка работы 6-го уровня, левой стороны (Начало) */
        ...
        /* Подготовка работы 6-го уровня, левой стороны (Конец) */

        /* Подготовка работы 6-го уровня, правой стороны (Начало) */
        // Генерация случайного числа
        ...
        /* Подготовка работы 6-го уровня, правой стороны (Конец) */
    ...
    protected void onStart() {
        super.onStart();
        Log.d(TAG, "Активити 6-го уровня становится видимым");
    }

    @Override
    protected void onResume(){
        super.onResume();
        Log.d(TAG, "Активити 6-го уровня получает фокус и переходит в состояние onResume");
    }

    @Override
    protected void onPause(){
        super.onPause();
        Log.d(TAG, "Активити 6-го уровня приостановленно и находится в состоянии onPause");
        if (sound_lvl != null) {
            sound_lvl.pause();
        }
    ...
    protected void onStop(){
        super.onStop();
        Log.d(TAG, "Активити 6-го уровня остановленно и находится в состоянии onStop");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
    ...
    protected void onDestroy(){
        super.onDestroy();
        Log.d(TAG, "Активити 6-го уровня уничтожено и находится в состоянии onDestroy");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
