...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Активити 4-го уровня создано");
...
//        w.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        textdescription.setText(R.string.dialogtext4_1);
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    // Intent - намерение
                    Intent intent = new Intent(Level4.this, Level_Menu.class);
                    // Запуск намериния
        ...
        btndialogcontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    Intent intent = new Intent(Level4.this, Level5plot1.class);
                    startActivity(intent);
                    finish();
                }
                catch (Exception e){
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level4.this, Level_Menu.class); // СОздание намерения перехода
    ...
    protected void onStart() {
        super.onStart();
        Log.d(TAG, "Активити 4-го уровня становится видимым");
    }

    @Override
    protected void onResume(){
        super.onResume();
        Log.d(TAG, "Активити 4-го уровня получает фокус и переходит в состояние onResume");
    }

    @Override
    protected void onPause(){
        super.onPause();
        Log.d(TAG, "Активити 4-го уровня приостановленно и находится в состоянии onPause");
        if (sound_lvl != null) {
            sound_lvl.pause();
        }
    ...
    protected void onStop(){
        super.onStop();
        Log.d(TAG, "Активити 4-го уровня остановленно и находится в состоянии onStop");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
    ...
    protected void onDestroy(){
        super.onDestroy();
        Log.d(TAG, "Активити 4-го уровня уничтожено и находится в состоянии onDestroy");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
