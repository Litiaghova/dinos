...
public class Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Активити 8-го уровня создано");
...
//        w.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        textdescription.setText(R.string.dialogtext8_1);
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    // Intent - намерение
                    Intent intent = new Intent(Level8.this, Level_Menu.class);
                    // Запуск намериния
        ...
        textDescriptionEnd.setText(R.string.dialogtext8_2);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level8.this, Level_Menu.class); // СОздание намерения перехода
    ...
    protected void onStart() {
        super.onStart();
        Log.d(TAG, "Активити 8-го уровня становится видимым");
    }

    @Override
    protected void onResume(){
        super.onResume();
        Log.d(TAG, "Активити 8-го уровня получает фокус и переходит в состояние onResume");
    }

    @Override
    protected void onPause(){
        super.onPause();
        Log.d(TAG, "Активити 8-го уровня приостановленно и находится в состоянии onPause");
        if (sound_lvl != null) {
            sound_lvl.pause();
        }
    ...
    protected void onStop(){
        super.onStop();
        Log.d(TAG, "Активити 8-го уровня остановленно и находится в состоянии onStop");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
    ...
    protected void onDestroy(){
        super.onDestroy();
        Log.d(TAG, "Активити 8-го уровня уничтожено и находится в состоянии onDestroy");
        if (sound_lvl != null) {
            sound_lvl.stop();
        }
    }
